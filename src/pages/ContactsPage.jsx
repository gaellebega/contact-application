...
const ContactsPage = () => {
    ...
    return (
        <div className='flex flex-col items-center'>
            <button className='bg-gray-800 text-white font-bold py-1 px-2 mt-4 mb-4'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                    {contacts.map((contact, index) => (
                        <div key={index} className='border border-gray-300 rounded-lg p-4'>
                            ...
                            <Link to={`/details/${contact._id}`} className='bg-green-900 text-white font-bold py-1 px-2 mt-2 rounded-lg'>
    View
</Link>   
                            </div>
                        </div>
