...
const Details = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      <div className="max-w-md mx-auto mt-10 bg-gray-white rounded-lg shadow-md overflow-hidden">
        <div className="p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <button onClick={() => navigate(`/update/${contact._id}`)} className="py-3 px-6 bg-green-500 text-white rounded-lg text-base hover:bg-green-800 transition duration-300">Update</button>
              <button onClick={deleteContact} className="py-3 px-6 bg-gray-900 text-white rounded-lg text-base hover:bg-gray-700 transition duration-300">Delete</button>
            </div>
          </div>
          <div className="mt-4">
