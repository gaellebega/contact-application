      ...
      <div className="max-w-md mx-auto mt-10 bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-4">
          ...
          <form onSubmit={updateContact} className="flex flex-col gap-4">
            ...
            <button type="submit" className="mt-5 py-3 px-6 bg-gray-900 text-white rounded-lg text-base hover:bg-white-700 transition duration-300">Update</button>
            {message && <p className="bg-green-200 text-green-900 p-3 rounded-lg">{message}</p>}
            {error && <p className="bg-red-200 text-gray-900 p-3 rounded-lg">{error}</p>}
          </form>
        </div>
      </div>
    </div>
